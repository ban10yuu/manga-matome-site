...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    keywords: [manga.title, manga.titleEn, `${manga.title} 考察`, `${manga.title} ネタバレ`, `${manga.title} 伏線`, '考察', 'ネタバレ', '伏線', ...manga.genre],
    openGraph: {
      title: `${manga.title}の考察・ネタバレまとめ`,
      description: `${manga.title}の考察・伏線・キャラクター分析をお届け。`,
      url: `https://manga-matome.vercel.app/manga/${slug}`,
      siteName: 'マンガ考察ラボ',
    },
    alternates: {
      canonical: `https://manga-matome.vercel.app/manga/${slug}`,
    },
  };
}
